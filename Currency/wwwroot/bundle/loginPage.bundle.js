...
/***/ "./Src/modules/profile/actions.ts":
/*!****************************************!*\
  !*** ./Src/modules/profile/actions.ts ***!
  \****************************************/
...
/***/ "./Src/modules/profile/getters.ts":
/*!****************************************!*\
  !*** ./Src/modules/profile/getters.ts ***!
  \****************************************/
...
/*!**************************************!*\
  !*** ./Src/modules/profile/index.ts ***!
  \**************************************/
/*! exports provided: state, profile */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var Modules_profile_getters__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! Modules/profile/getters */ "./Src/modules/profile/getters.ts");
/* harmony import */ var Modules_profile_actions__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! Modules/profile/actions */ "./Src/modules/profile/actions.ts");
/* harmony import */ var Modules_profile_mutations__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! Modules/profile/mutations */ "./Src/modules/profile/mutations.ts");
...
const profile = {
    namespaced,
    state,
    getters: Modules_profile_getters__WEBPACK_IMPORTED_MODULE_0__["getters"],
    actions: Modules_profile_actions__WEBPACK_IMPORTED_MODULE_1__["actions"],
    mutations: Modules_profile_mutations__WEBPACK_IMPORTED_MODULE_2__["mutations"]
};


/***/ }),

/***/ "./Src/modules/profile/mutations.ts":
/*!******************************************!*\
  !*** ./Src/modules/profile/mutations.ts ***!
  \******************************************/
...
/* harmony import */ var _store__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./store */ "./Src/pages/login/store.ts");
...
/* harmony import */ var Modules_profile_index__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! Modules/profile/index */ "./Src/modules/profile/index.ts");
...
const store = {
    ...
    modules: {
        profile: Modules_profile_index__WEBPACK_IMPORTED_MODULE_2__["profile"]
    }
};
...
/* harmony import */ var vuex_class__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! vuex-class */ "./node_modules/vuex-class/lib/index.js");
...
__decorate([
    Object(vuex_class__WEBPACK_IMPORTED_MODULE_5__["State"])("profile")
], LoginComponent.prototype, "profile", void 0);
__decorate([
    Object(vuex_class__WEBPACK_IMPORTED_MODULE_5__["Action"])("logUserIn", { namespace: namespace })
], LoginComponent.prototype, "logUserIn", void 0);
__decorate([
    Object(vuex_class__WEBPACK_IMPORTED_MODULE_5__["Getter"])("userEmail", { namespace: namespace })
